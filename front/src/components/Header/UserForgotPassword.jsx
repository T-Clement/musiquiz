  ...
  return (
    <form onSubmit={handleSubmit}>
        <div className='space-y-6'>
            <div>
                <label className='text-gray-800 text-sm mb-2 block'>Email du compte</label>
                <input
                    name="email"
                    type="text"
                ...
                { message && <p className='text-blue-600 italic'>{ message }</p> }
            </div>

            <div className='mt-8'>
                <Button type="submit" variant="blue" disabled={isSubmitting} className='w-full'>
                { isSubmitting ? 
                    (<div role="status">
                        ...
                        <span className="">Demande en cours</span>
                    </div>)
                    :
                    "Envoyer"
                }
